    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-8 ftco-animate text-center">
                ...
                <h1 class="mb-3 bread">All Teachers</h1>
...
<div class="container-fluid table-responsive ">
    ...
    <table class="table table-striped  table-hover table-dark">
        ...
        foreach ($data as $List){
            ...
            echo "<td>$List[11]</td>";
            echo "<td>$List[12]</td>";
            echo "<td> <a href='deleteTeachers.php?id=$List[0]' class='btn btn-danger btn-outline-danger shadow'>Delete User</a> </td>";
            echo "<td> <a href='updateTeachers.php?id=$List[0]' class='btn btn-success btn-outline-success  shadow'>Update User</a> </td>";
            echo "</tr>";
        }
        ?>
