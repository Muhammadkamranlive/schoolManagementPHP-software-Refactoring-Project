...
if(isset($_POST['btnSubmit'])){
    ...
    $data=array($objectUsers->getFirstName(),$objectUsers->getLastName(),$objectUsers->getGender(),$objectUsers->getDateOfBirth(),$objectUsers->getAddress(),$objectUsers->getPhone(),$objectUsers->getEmail(),$objectUsers->getPlaceOfBirth(),$objectUsers->getNote());
