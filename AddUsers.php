...
if(isset($_POST['btnSubmit'])){
    ...
    $objectUsers->setUserName($_POST['Username']);
    $objectUsers->setPassword($_POST['Password']);
    $objectUsers->setTypeOfUser($_POST['type']);
    $objectUsers->setNoteForUser($_POST['note']);
    $data=array($objectUsers->getUserName(),$objectUsers->getPassword(),$objectUsers->getTypeOfUser(),$objectUsers->getNoteForUser());
    $objectUsers->AddUser($data);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-8 ftco-animate text-center">
                ...
                <h1 class="mb-3 bread">Add Users Page</h1>
    ...
    <div class="row block-9">
        <div class="col-md-12 pr-md-5">
            ...
            <form action="#" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Your Password" required name="Password">
                </div>
                <div class="form-group">
