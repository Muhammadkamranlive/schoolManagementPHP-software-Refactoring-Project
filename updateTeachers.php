...
<div class="container pt-lg-5">
    <div class="row block-9">
        <div class="col-md-12 pr-md-5">
            ...
            <form action="updatedTeachers.php" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Salary" required name="salary" value="<?php echo $data[10]?>" >
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="degree" required name="degree" value="<?php echo $data[11]?>" >
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="married" required name="married" value="<?php echo $data[12]?>" >
                </div>
                <div class="form-group">
